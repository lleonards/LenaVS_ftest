...
const api = axios.create({
  ...
  // A sincronização automática pode esperar a fila de CPU/RAM e depois
  // executar o alinhador. O backend continua protegendo a máquina; o cliente
  // apenas não cancela uma tarefa válida cedo demais.
  timeout: 1800000,
});
