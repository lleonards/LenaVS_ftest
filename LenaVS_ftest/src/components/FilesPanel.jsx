  ...
  const handleAutoSync = async () => {
    ...
    try {
      ...
      onNotify?.({
        ...
        message: 'Alinhando a letra com a música. Este recurso pode não ser 100% funcional.',
      });
      ...
      onNotify?.({
        ...
        message: `${syncedCount} de ${stanzas.length} blocos receberam tempo automaticamente. Ajuste manualmente o que precisar.`,
      });
    } catch (error) {
      ...
      onNotify?.({
        ...
        message: error.response?.data?.error || error.message || 'Não foi possível sincronizar automaticamente.',
      });
    } finally {
          ...
          >
            {isAutoSyncing ? (
              <span className="auto-sync-btn-content">
                ...
                <span className="auto-sync-btn-note">este recurso pode não 100% funcional</span>
              </span>
            ) : (
              <span className="auto-sync-btn-content">
                <span className="auto-sync-btn-main">
