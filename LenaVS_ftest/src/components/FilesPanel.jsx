...
const FilesPanel = ({
  ...
  {isCreatingInstrumental
    ...
    : !mediaFiles?.musicaOriginal
      ...
      {/* ── Sincronizar automaticamente (WhisperX) ─────────────────── */}
      <div className="auto-sync-section">
        <div className="auto-sync-wrapper">
          <button
            type="button"
          ...
          >
            {isSyncingLyrics ? (
              ...
              <span className="auto-sync-btn-content">
                ...
                <span className="auto-sync-btn-note">WhisperX define os tempos de cada bloco</span>
              </span>
            )}
          </button>
        </div>
        ...
        <p className="auto-sync-hint">
          {isSyncingLyrics
            ? 'Analisando a música e a letra... isso pode levar alguns minutos.'
            : !mediaFiles?.musicaOriginal
              ? 'Faça upload da música original para habilitar.'
              : stanzaCount === 0
                ? 'Adicione a letra para habilitar.'
                : 'Este recurso pode não funcionar 100%.'}
        </p>
      </div>
