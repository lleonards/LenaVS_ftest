...
const LyricsEditorPanel = ({
  ...
  const nudgeTimeField = (id, field, delta) => {
    const stanza = stanzas.find((item) => item.id === id);
    const current = parseFixedTimecode(stanza?.[field]) ?? 0;
    const next = Math.max(0, current + delta);
    updateTimeField(id, field, formatFixedTimecode(next), true);
  };
              ...
              <div className="lep-time-row">
                <div className="lep-field lep-field-time">
                  ...
                  <div className="lep-time-input-group">
                    ...
                    <button type="button" className="lep-tap-btn" onClick={() => nudgeTimeField(stanza.id, 'startTime', -0.1)} disabled={restrictToLineControls} aria-label="Adiantar início em 100 milissegundos" title="Adiantar 100 ms">−</button>
                    <button type="button" className="lep-tap-btn" onClick={() => nudgeTimeField(stanza.id, 'startTime', 0.1)} disabled={restrictToLineControls} aria-label="Atrasar início em 100 milissegundos" title="Atrasar 100 ms">+</button>
                    <button
                      type="button"
                ...
                <div className="lep-field lep-field-time">
                  ...
                  <div className="lep-time-input-group">
                    ...
                    <button type="button" className="lep-tap-btn" onClick={() => nudgeTimeField(stanza.id, 'endTime', -0.1)} disabled={restrictToLineControls} aria-label="Adiantar fim em 100 milissegundos" title="Adiantar 100 ms">−</button>
                    <button type="button" className="lep-tap-btn" onClick={() => nudgeTimeField(stanza.id, 'endTime', 0.1)} disabled={restrictToLineControls} aria-label="Atrasar fim em 100 milissegundos" title="Atrasar 100 ms">+</button>
                    <button
                      type="button"
                      className="lep-tap-btn"
