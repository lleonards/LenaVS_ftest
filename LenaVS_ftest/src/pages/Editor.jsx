...
import useLyricsSync from '../utils/useLyricsSync';
...
const Editor = () => {
  ...
  // Sincronização automática: usa a música original + a letra já dividida em
  // blocos e devolve só os tempos (início = 1ª palavra, fim = última palavra).
  const { canSync: canAutoSyncLyrics, syncLyrics } = useLyricsSync({
    stanzas,
    mediaFiles,
